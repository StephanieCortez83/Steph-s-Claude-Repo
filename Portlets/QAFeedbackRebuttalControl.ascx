<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QAFeedbackRebuttalControl.ascx.cs" Inherits="CCSWeb.WebPages.Controls.Portlets.QAFeedbackRebuttalControl" %>
<h2>Review QA Results from Audited Charts</h2>

<br />

<link href="Resources/SaAlerts.css" type="text/css" rel="stylesheet" />
...
<div style="display: flex; flex-direction: column;">
    ...
    <div class="alert alert-info" role="alert">
        ...
        All entries must be addressed prior to submitting changes
    </div>
    
    <!-- Unanswered chart errors (coder or auditor) -->
    <div id="divChartResponses" style="padding: 15px;" runat="server" visible="false">        
        <!-- Coder chart errors -->
        <div id="divCoderChartResponses" runat="server" visible="false">
            <table>
                <tr>
                    <td style="width: 70%">
                        <asp:Label 
                            ID="Label17" 
                            CssClass="FieldLabel" 
                            Text="Coder Chart Errors (response required)" 
                            Font-Size="Large" 
                            runat="server">
                        </asp:Label>
                    </td>
            ...
            <table runat="server">
                <tr>
                    <td valign="top" align="left">
                        <asp:DataGrid 
                            ID="grdCoderChartErrors" 
                            runat="server" 
                            OnItemDataBound="grdCoderChartErrors_ItemDataBound" 
                            OnItemCommand="grdScorecardResults_ItemCommand" 
                            CssClass="ListTable" 
                            DataSource="<%# m_CoderChartErrors %>"
                            AutoGenerateColumns="False" 
                            DataKeyField="ChartID" 
                            AllowPaging="False">
                            ...
                            <Columns>
                                <asp:TemplateColumn Visible="false">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblChartId"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                ...
                                <asp:TemplateColumn HeaderText="">
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton 
                                            ID="lnkAuditReviewCoder" 
                                            CommandName="AuditReview" 
                                            runat="server">
                                            View
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateColumn HeaderText="Auditor Notes">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblAuditorNotes" Width="150"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>

                                <asp:TemplateColumn HeaderText="Coder Response">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:DropDownList runat="server" ID="ddlCoderResponse" CssClass="StdInput">
                                        </asp:DropDownList> <br />
                                        
                                        <asp:Label 
                                            runat="server" 
                                            ID="lblCoderResponseValidationMessage" 
                                            CssClass="StdError"
                                            Visible="false"
                                ...
                                <asp:TemplateColumn HeaderText="Coder Response Comments">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox 
                                            runat="server" 
                                            TextMode="MultiLine" 
                                            ID="txtCoderResponseComments" 
                                            MaxLength="500">
                                        </asp:TextBox><br />
                                        
                                        <asp:Label 
                                            runat="server" 
                                            ID="lblCoderResponseCommentsValidationMessage" 
                                            CssClass="StdError"
                                            Visible="false"
                                            style="display: inline-block; margin-top: 3px">
                                        </asp:Label>
        ...
        <!-- Chart errors that are waiting for auditor response -->
        <div id="divAuditorChartResponses" runat="server" visible="false">
            <table>
                <tr>
                    <td style="width: 70%">
                        <asp:Label 
                            ID="Label47" 
                            CssClass="FieldLabel" 
                            Text="Chart Errors Awaiting Auditor Response (response required)" 
                            Font-Size="Large" 
                            runat="server">
                        </asp:Label>
                    </td>
            ...
            <table id="Table1" runat="server">
                <tr>
                    <td valign="top" align="left">
                        <asp:DataGrid 
                            ID="grdChartErrorAuditorResponse" 
                            runat="server" 
                            OnItemDataBound="grdChartErrorAuditorResponse_ItemDataBound" 
                            OnItemCommand="grdScorecardResults_ItemCommand" 
                            CssClass="ListTable" 
                            DataSource="<%# m_AuditorChartErrorResponses %>"
                            AutoGenerateColumns="False" 
                            DataKeyField="ChartID" 
                            AllowPaging="False">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Auditor Response">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:DropDownList runat="server" ID="ddlAuditorResponse">
                                        </asp:DropDownList> <br />
                                        
                                        <asp:Label 
                                            runat="server" 
                                            ID="lblAuditorResponseValidationMessage" 
                                            CssClass="StdError"
                                            Visible="false">
                                        </asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateColumn HeaderText="Auditor Response Comments">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:TextBox 
                                            runat="server" 
                                            TextMode="MultiLine" 
                                            ID="txtAuditorResponseComments" 
                                            MaxLength="500">
                                        </asp:TextBox> <br />
                                        
                                        <asp:Label 
                                            runat="server" 
                                            ID="lblAuditorResponseCommentsValidationMessage" 
                                            CssClass="StdError"
                                            Visible="false">
                                        </asp:Label>
                                    </ItemTemplate>
    ...
    <!-- Coder and Auditor scorecards -->
    <div id="divScorecards" style="padding: 15px;">
        <!-- Date range control -->
        <table id="dateRangeControl">
            <tr>
                <td>
                    <asp:Label ID="lblSummaryCoder" Text="Summary:" CssClass="FieldLabel" Font-Size="Large" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td id="tdDateRange" runat="server">
                    <br />
                    <div id="divDateRange" runat="server" class="form-field">
            ...
            <tr>
                <td style="width: 70%">
                    <asp:Label ID="lblNote" CssClass="FieldLabel" Text="*Note: Post-Bill Audit data is not included in Scorecard metrics." ForeColor="Red" Font-Size="smaller" runat="server"></asp:Label>
                </td>
            </tr>
        ...
        <!-- Coder scorecard -->
        <div id="divCoderScorecard" runat="server" visible="false">
            ...
            <table id="tblCoderSummary" runat="server">
                ...
                <table style="width: 97%">
                    <tr>
                        <td valign="top" align="left">
                            <asp:DataGrid ID="grdResults" runat="server" OnItemDataBound="grdResults_ItemDataBound" OnItemCommand="grdResults_ItemCommand" CssClass="ListTable" DataSource="<%# m_FeedbackResults %>"
            ...
            <div id="divScorecardCoderSummary" runat="server" visible="false">
        ...
        <!-- Auditor scorecard -->
        <div id="divAuditorScorecard" runat="server" visible="false">
            ...
            <div id="divAuditorResults" runat="server" visible="false">
                ...
                <table style="width: 97%">
                    <tr>
                        <td valign="top" align="left">
                            <asp:DataGrid ID="grdResultsAuditor" runat="server" OnItemCommand="grdResults_ItemCommand" OnItemDataBound="grdResultsAuditor_ItemDataBound" CssClass="ListTable" DataSource="<%# m_FeedbackResultsAuditor %>"
                                AutoGenerateColumns="False" DataKeyField="ChartID" AllowPaging="False">
                                <AlternatingItemStyle CssClass="ListRow2"></AlternatingItemStyle>
                                <ItemStyle CssClass="ListRow1"></ItemStyle>
                                <HeaderStyle CssClass="ColHeading"></HeaderStyle>
            ...
            <div id="divScorecardAuditorSummary" runat="server" visible="false">
                ...
                <table id="tblScorecardAuditorSummary" runat="server" border="1">
                    ...
                    <tr>
                        ...
                        <td></td>
                            <td>
                                <asp:Label ID="Label57" Text="Anesthesia: "  runat="server" ></asp:Label>
                            </td>
                            <td>
                ...
                <br />
                <div id="divScorecardAuditorResults" runat="server" visible="false">
            <div id="divScorecardAuditorDetails" runat="server" visible="false">
                <table>
                    <tr>
                        <td>
                ...
                <table style="width: 97%" id="tblAuditorDetailsGrid" runat="server">
                    <tr>
                        <td valign="top" align="left">
                            <asp:DataGrid ID="grdScorecardAuditorDetails" runat="server" OnItemDataBound="grdScorecardAuditorDetails_ItemDataBound" OnItemCommand="grdScorecardResults_ItemCommand" CssClass="ListTable" DataSource="<%# m_ScorecardAuditorItems %>"
                                AutoGenerateColumns="False" DataKeyField="ChartID" AllowPaging="False">
                                <AlternatingItemStyle CssClass="ListRow2"></AlternatingItemStyle>
                                <ItemStyle CssClass="ListRow1"></ItemStyle>
                                <HeaderStyle CssClass="ColHeading"></HeaderStyle>
        ...
        <!-- All chart errors that have been answered or are second level audit -->
        <div id="divAllChartErrors" runat="server" visible="false">
            <table>
                <tr>
                    <td style="width: 70%">
                        <asp:Label ID="Label54" CssClass="FieldLabel" Text="Answered Chart Errors for Coder and Auditor" Font-Size="Large" runat="server"></asp:Label>
                    </td>
                </tr>
            </table>
            <table id="Table2" runat="server">
                <tr>
                    <td valign="top" align="left">
                        <asp:DataGrid ID="grdAllChartErrors" runat="server" OnItemDataBound="grdAllChartErrors_ItemDataBound" OnItemCommand="grdScorecardResults_ItemCommand" CssClass="ListTable" DataSource="<%# m_AllChartErrors %>"
                            AutoGenerateColumns="False" DataKeyField="ChartID" AllowPaging="False">
                            <AlternatingItemStyle CssClass="ListRow2"></AlternatingItemStyle>
                            <ItemStyle CssClass="ListRow1"></ItemStyle>
                            <HeaderStyle CssClass="ColHeading"></HeaderStyle>
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Coder Response">
                                    ...
                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblCoderResponse"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Coder Response Comments">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblCoderResponseComment" Width="150"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                ...
                                <asp:TemplateColumn HeaderText="Auditor Response">
                                    ...
                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblAuditorResponse"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Auditor Response Comments">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblAuditorResponseComment" Width="150"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Audit Type">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    <ItemStyle Width="6%" HorizontalAlign="Center"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblPostBillAuditType"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
                        </asp:DataGrid>
